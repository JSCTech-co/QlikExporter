define(["qlik", "jquery", "../lib/html2canvas.min", "./fileUtils", "./state", "./loadingOverlay", "./checkUtils", "../lib/htmltoimage.min"],
	function (qlik, $, html2canvas, fileUtils, state, overlay, checkUtils, htmltoimage) {
